...
* **ask-user-question:** key answers by question text so the model sees them ([ea20f5b](https://github.com/croll83/companion/commit/ea20f5b))
...
* add copy buttons for AI messages and code blocks ([d17f71e](https://github.com/croll83/companion/commit/d17f71e97bbc4eb728b79ac25a29b8f103a209b0))
* add Linux systemd support for service install/uninstall ([#169](https://github.com/croll83/companion/issues/169)) ([73fb3f7](https://github.com/croll83/companion/commit/73fb3f721efde79fec50f9c74a4f078f821c35d3))
* add MCP server management support ([#198](https://github.com/croll83/companion/issues/198)) ([018cf1f](https://github.com/croll83/companion/commit/018cf1f65ea5e281c19a39367f8cccf14ac56c1f))
* add release-please for automated npm publishing ([#24](https://github.com/croll83/companion/issues/24)) ([93b24ee](https://github.com/croll83/companion/commit/93b24ee4a12b3f32e81f59a348b25e89aaa86dce))
* **agents:** add conversational chat SDK, cloud relay, and runs view ([#471](https://github.com/croll83/companion/issues/471)) ([e8420c8](https://github.com/croll83/companion/commit/e8420c824cc07b8bb374ec15b6b01653e94daef6))
* **agents:** add Linear Agent Interaction SDK integration ([#486](https://github.com/croll83/companion/issues/486)) ([64b838d](https://github.com/croll83/companion/commit/64b838de84c4c5b21ee4b43d6853f36975a6923b))
* **agents:** add per-agent chat platform credentials ([#477](https://github.com/croll83/companion/issues/477)) ([afb9557](https://github.com/croll83/companion/commit/afb95575615516600a284666f6f55c5c121e9650))
* **agents:** add reusable agent system with triggers, MCP, and scheduling ([#397](https://github.com/croll83/companion/issues/397)) ([1849d5d](https://github.com/croll83/companion/commit/1849d5d7c2a2b3d4036f8b2aebd1adc84f14258e))
* **ai-validator:** add actionable error reasons for AI validation failures ([#457](https://github.com/croll83/companion/issues/457)) ([ab5455e](https://github.com/croll83/companion/commit/ab5455e33d7c148a62e8abb81c31306b4ed3d50f))
* allow dev server access over Tailscale/LAN ([#33](https://github.com/croll83/companion/issues/33)) ([9599d7a](https://github.com/croll83/companion/commit/9599d7ad4e2823d51c8fa262e1dcd96eeb056244))
* **assistant:** add Companion — persistent AI assistant session ([#268](https://github.com/croll83/companion/issues/268)) ([ec0e90b](https://github.com/croll83/companion/commit/ec0e90b8b58f0ec09104590b182941a4d7c9b503))
* **browser:** add browser preview for containerized sessions ([#505](https://github.com/croll83/companion/issues/505)) ([2e61e76](https://github.com/croll83/companion/commit/2e61e768ec3a99dea37212fe39bff3681ededdc9))
* **browser:** add browser preview tab with dual-mode support (container VNC + host proxy) ([#508](https://github.com/croll83/companion/issues/508)) ([4a30f96](https://github.com/croll83/companion/commit/4a30f9699d7ccfa749a1c0cf0477dbc2b433b21f))
* claude.md update ([7fa4e7a](https://github.com/croll83/companion/commit/7fa4e7adfdc7c409cfeed4e8a11f237ff0572234))
* **claude:** support channels protocol updates ([#613](https://github.com/croll83/companion/issues/613)) ([5baccb1](https://github.com/croll83/companion/commit/5baccb13ba0b87d2dfcaa9e0241951ca9febc684))
* **cli:** add service install/uninstall and separate dev/prod ports ([#155](https://github.com/croll83/companion/issues/155)) ([a4e5ba6](https://github.com/croll83/companion/commit/a4e5ba6ced2cc8041f61b303b0205f36e50b7594))
* **cli:** add stop and restart service commands ([#185](https://github.com/croll83/companion/issues/185)) ([04da8e5](https://github.com/croll83/companion/commit/04da8e5a3d3f0e363f662cdd6bca6145eaec479f))
* **cli:** start and stop Companion via daemon service ([#201](https://github.com/croll83/companion/issues/201)) ([39e2b79](https://github.com/croll83/companion/commit/39e2b79a6dbb70e7c7dcaf3ccbaf2116ac26b43a))
* **codex:** add offline protocol compatibility guardrails and playground coverage ([#194](https://github.com/croll83/companion/issues/194)) ([bf0a43e](https://github.com/croll83/companion/commit/bf0a43e5fdc791166e76391c0ee1ad3cf18dae10))
* **codex:** add plan mode with runtime Auto↔Plan toggle ([#325](https://github.com/croll83/companion/issues/325)) ([21ef723](https://github.com/croll83/companion/commit/21ef7237b9666ebd4cc5689c5db05a4b26f10bdd))
* **composer:** pre-populate slash commands and skills on session creation ([#500](https://github.com/croll83/companion/issues/500)) ([79b4664](https://github.com/croll83/companion/commit/79b466417631ab9f345e05d6d3d55d1786cdf398))
* **containers:** add Codex CLI support in Docker sessions ([#290](https://github.com/croll83/companion/issues/290)) ([992604b](https://github.com/croll83/companion/commit/992604b229542de87cacd8547c7d74955b05c5d8))
* **containers:** implement workspace isolation and git auth seeding in Docker sessions ([d651cc3](https://github.com/croll83/companion/commit/d651cc3144f65c939bdcb91f7f6900951a161552))
* **containers:** pull Docker images from ghcr.io + session creation progress UI ([#281](https://github.com/croll83/companion/issues/281)) ([e87cfae](https://github.com/croll83/companion/commit/e87cfaed99010c37e12eca5adcaa30e8e5c07cb6))
* **containers:** replace git worktree isolation with Docker container-based sessions ([#277](https://github.com/croll83/companion/issues/277)) ([92a6172](https://github.com/croll83/companion/commit/92a6172db4bfa4bef613f21fa1bc243c848f7b9d))
* **containers:** seed git auth (gitconfig + gh token) in Docker sessions ([198be0e](https://github.com/croll83/companion/commit/198be0ef7465e3d355e34945fa67151e0457f096))
* Corriger menu dossier mobile et décalage clavier ([#151](https://github.com/croll83/companion/issues/151)) ([8068925](https://github.com/croll83/companion/commit/8068925f6a5ec5c6b7a40b36398bd4f9be04708d))
* **cron:** add scheduled task system for autonomous sessions ([#84](https://github.com/croll83/companion/issues/84)) ([e02c55a](https://github.com/croll83/companion/commit/e02c55a079bb0f81b71bc7a1fd44b23181d97bb1))
* Development environment setup ([#472](https://github.com/croll83/companion/issues/472)) ([99fed7c](https://github.com/croll83/companion/commit/99fed7c1e35315e9bcec79ebd937010019796e20))
* **diff:** add diff base setting (last commit vs default branch) ([#308](https://github.com/croll83/companion/issues/308)) ([2a7f427](https://github.com/croll83/companion/commit/2a7f4271ef021db67c5b57d6509fe54853e930cc))
* **diff:** use git diff as source of truth; show A/M/D status icons and deleted files ([#385](https://github.com/croll83/companion/issues/385)) ([d1e0db5](https://github.com/croll83/companion/commit/d1e0db5f9b94bd5fe055455bf6b4f69714e350f5))
* **docker:** add Cubic CLI to the-companion image ([#499](https://github.com/croll83/companion/issues/499)) ([2b45aaa](https://github.com/croll83/companion/commit/2b45aaa2790e41cff2c940adb26106ddf06729ef))
* **docker:** add Docker-in-Docker and PostgreSQL to default image ([#596](https://github.com/croll83/companion/issues/596)) ([1bbfda0](https://github.com/croll83/companion/commit/1bbfda01943f798c877dd13759298efb6d32a0a5))
* **docker:** add standalone docker-compose CLI to default image ([#598](https://github.com/croll83/companion/issues/598)) ([d9611da](https://github.com/croll83/companion/commit/d9611dade088b9f5c2726e90eea2a8ae12175147))
* **docker:** background image pulls and streaming creation progress ([#311](https://github.com/croll83/companion/issues/311)) ([f3a7a5e](https://github.com/croll83/companion/commit/f3a7a5e48bbb371b828f8ffe53c8ad3448f1c07b))
* **editor:** move VS Code editor to dedicated tab with host fallback ([#358](https://github.com/croll83/companion/issues/358)) ([c169027](https://github.com/croll83/companion/commit/c169027ae77f28b9d491c4172b1e01e2af95c3a7))
* Fix Diffs panel for worktree/relative paths and untracked files ([#165](https://github.com/croll83/companion/issues/165)) ([6810643](https://github.com/croll83/companion/commit/681064328d2bf3f4fc5c3a1867abc1536d2d54f3))
* **folder-picker:** redesign with accessibility, keyboard nav, breadcrumbs, and search ([#568](https://github.com/croll83/companion/issues/568)) ([2d76819](https://github.com/croll83/companion/commit/2d768195b60fead3853e02dd3c160987975e42dc))
* Hide successful no-output command results ([#139](https://github.com/croll83/companion/issues/139)) ([a66e386](https://github.com/croll83/companion/commit/a66e386491e6887c5684cd70f63cc49cac0a64b7))
* **home:** pro ChatGPT/Cursor-style homepage redesign ([#570](https://github.com/croll83/companion/issues/570)) ([d698ebb](https://github.com/croll83/companion/commit/d698ebb4f80a73f11c2ee947ccb0206f2b9e23b8))
* **home:** redesign HomePage selectors into grouped sections ([#566](https://github.com/croll83/companion/issues/566)) ([6c5d255](https://github.com/croll83/companion/commit/6c5d255cfc860f2cb4c8c66357afec34ea3b2f3d))
* improve Enter key behavior on mobile devices ([bb9cc23](https://github.com/croll83/companion/commit/bb9cc23eef11674370bdc703bb97e8b08918faff))
* **integrations:** add linear setup, issue search, and startup context ([#326](https://github.com/croll83/companion/issues/326)) ([4612288](https://github.com/croll83/companion/commit/461228845965c45236c0e492f6bef50b71e80a24))
* **integrations:** add Tailscale Funnel integration for one-click HTTPS ([#482](https://github.com/croll83/companion/issues/482)) ([a79f1fd](https://github.com/croll83/companion/commit/a79f1fd4f45dad176a2f718029e4c6625cdd7f02))
* **integrations:** associate Linear ticket with session in TaskPanel ([#333](https://github.com/croll83/companion/issues/333)) ([943bf36](https://github.com/croll83/companion/commit/943bf36cd3f8fbdfc3f73fa48e7d9cd76fd12ea4))
* **integrations:** attach Linear project to git repo and show recent issues on homepage ([#331](https://github.com/croll83/companion/issues/331)) ([54239d7](https://github.com/croll83/companion/commit/54239d76f12cc7fea06f76ecd4957b8c06a50f05))
* **integrations:** auto-transition Linear issue to In Progress on session launch ([#332](https://github.com/croll83/companion/issues/332)) ([1df0c8c](https://github.com/croll83/companion/commit/1df0c8cb1d9c82f2756047af661611640de42836))
* **keepalive:** proactive CLI relaunch when frontend is disconnected ([#634](https://github.com/croll83/companion/issues/634)) ([6a0e7c5](https://github.com/croll83/companion/commit/6a0e7c599c1700ca750fee2b6ad93f8aed362e99))
* **landing:** add marketing landing page for thecompanion.sh ([#128](https://github.com/croll83/companion/issues/128)) ([170b89c](https://github.com/croll83/companion/commit/170b89c72012dfb0ba68239a7665634d65275aa3))
* **linear:** add guided Linear Agent setup wizard ([#522](https://github.com/croll83/companion/issues/522)) ([0bf218d](https://github.com/croll83/companion/commit/0bf218de9fd078c5fc190224b0f620392fe71759))
* **linear:** auto-create recommended branch when starting session with Linear issue ([#329](https://github.com/croll83/companion/issues/329)) ([51972b7](https://github.com/croll83/companion/commit/51972b78b32f6a7b2701016b55bf0675a4e13bc3))
* **linear:** inject Linear context into CLI system prompt ([#497](https://github.com/croll83/companion/issues/497)) ([db0ae68](https://github.com/croll83/companion/commit/db0ae6843da948273844acb2f7f9adafa05a42a3))
* **linear:** support multi-agent OAuth with per-wizard staging slots and UI redesign ([#586](https://github.com/croll83/companion/issues/586)) ([0b2d38a](https://github.com/croll83/companion/commit/0b2d38a8b874f666c5f97632c26f4db49884a3ca))
* **linear:** support multiple Linear connections with API key injection ([#496](https://github.com/croll83/companion/issues/496)) ([3c76a4b](https://github.com/croll83/companion/commit/3c76a4b8331f1519be1abb34476e53186dd57b48))
* Menu esthétique ergonomie ([#474](https://github.com/croll83/companion/issues/474)) ([033a854](https://github.com/croll83/companion/commit/033a8547d18bee4fd12b71fadb9322a1f445ef9c))
* **multi-agent:** enable codex by default and improve subagent UI ([#444](https://github.com/croll83/companion/issues/444)) ([973ca5f](https://github.com/croll83/companion/commit/973ca5facc9f9c1b36b3b48f0d7183c8fa54da47))
* **onboarding:** add provider setup wizard for Claude Code and Codex ([#615](https://github.com/croll83/companion/issues/615)) ([c2f2b55](https://github.com/croll83/companion/commit/c2f2b55118cb576532746cbde87eab4de4b87001))
* OpenRouter-based session auto-naming + settings page ([#168](https://github.com/croll83/companion/issues/168)) ([a86b1e7](https://github.com/croll83/companion/commit/a86b1e711ff1c38985bb3d622c6ec372a266637e))
* **platform:** add Companion Cloud managed platform foundation ([#401](https://github.com/croll83/companion/issues/401)) ([cdd6a0c](https://github.com/croll83/companion/commit/cdd6a0c1df616ffd16439339b0be745c812ad16a))
* **platform:** add hetzner provider and instance scaling ([#525](https://github.com/croll83/companion/issues/525)) ([4618efa](https://github.com/croll83/companion/commit/4618efad9fe4cf4dae634773784fe76460aa639a))
* **platform:** non-blocking instance creation with SSE streaming ([#518](https://github.com/croll83/companion/issues/518)) ([5972d60](https://github.com/croll83/companion/commit/5972d60954e1f34b010811e2d47caafa02557d84))
* **platform:** Railway deploy config, Resend emails, postgres.js driver ([#594](https://github.com/croll83/companion/issues/594)) ([eb64cb0](https://github.com/croll83/companion/commit/eb64cb0510a205c86964830592b4a5fcc9b99016))
* **plugins:** add event-driven plugin runtime with frontend integration ([#251](https://github.com/croll83/companion/issues/251)) ([fdc7418](https://github.com/croll83/companion/commit/fdc7418b7e0a0e17e31e0dbeaf45a7c0fad810cc))
* **prompts:** add global prompt library with @ insertion ([#319](https://github.com/croll83/companion/issues/319)) ([10b97b4](https://github.com/croll83/companion/commit/10b97b450c26e57ee0a2a5c96f42bc2c27cbb0c7))
* **recording-hub:** add hidden recording hub for replay, compat testing, and diagnostics ([#617](https://github.com/croll83/companion/issues/617)) ([6f6d411](https://github.com/croll83/companion/commit/6f6d411cc4e7cb7d16216f179212ef7ea44e4a40))
* **routing:** add session ID to URL hash for deep-linking ([#289](https://github.com/croll83/companion/issues/289)) ([ddd15ac](https://github.com/croll83/companion/commit/ddd15ac194390eb7b7bf4d7ff0850d71b2ff498a))
* **sandbox:** add init script testing and remove Dockerfile support ([#520](https://github.com/croll83/companion/issues/520)) ([39dc238](https://github.com/croll83/companion/commit/39dc238da6a4922e39bce5f1c71064f37c1c5a08))
* **sandbox:** enable sandbox system for Codex backend ([#521](https://github.com/croll83/companion/issues/521)) ([ea856b1](https://github.com/croll83/companion/commit/ea856b1668e4132e2aacbcf30e3ef43b61011f61))
* **sandbox:** separate sandbox from environment management ([#516](https://github.com/croll83/companion/issues/516)) ([d38dcc3](https://github.com/croll83/companion/commit/d38dcc34623048fdf881584691f9dabfad025d0d))
* **server:** add always-on session recorder with line-based rotation ([#262](https://github.com/croll83/companion/issues/262)) ([369df07](https://github.com/croll83/companion/commit/369df07642f74f7abb523ed0323912f4f6b3d989))
* **server:** add log file persistence with automatic rotation ([#554](https://github.com/croll83/companion/issues/554)) ([52d1cc0](https://github.com/croll83/companion/commit/52d1cc036561e6a9b4c9044f6391293c2c43b0c4))
* **server:** add runtime observability and reliability metrics ([#550](https://github.com/croll83/companion/issues/550)) ([4fdadd3](https://github.com/croll83/companion/commit/4fdadd3013503a882482c0c16e7f82008201cf0b))
* **server:** allow configuring session storage directory via COMPANION_SESSION_DIR ([#266](https://github.com/croll83/companion/issues/266)) ([3a63bc9](https://github.com/croll83/companion/commit/3a63bc915a16844aa2fbf33f08b60587efb9ea4a))
* **server:** formalize session state machine and transitions ([#541](https://github.com/croll83/companion/issues/541)) ([0cc85c1](https://github.com/croll83/companion/commit/0cc85c1703220d949ce0ca6f8f56d876ed59387d))
* **server:** implement typed internal event bus ([#536](https://github.com/croll83/companion/issues/536)) ([d8fa90b](https://github.com/croll83/companion/commit/d8fa90b7a38892267f1676187dece78ee272d308))
* **session-ui:** redesign tabs, terminal persistence and composer ([#306](https://github.com/croll83/companion/issues/306)) ([4a7fe9f](https://github.com/croll83/companion/commit/4a7fe9f4bdeef0dd41bb24d16dd530ed8c6e1939))
* **session:** add VS Code editor pane beside shell ([#354](https://github.com/croll83/companion/issues/354)) ([ab10a8d](https://github.com/croll83/companion/commit/ab10a8d09f200ba38a3ee3138505a868b94ace25))
* **settings:** add application update controls to settings ([#234](https://github.com/croll83/companion/issues/234)) ([17760af](https://github.com/croll83/companion/commit/17760afb3cade5e325b7771cabbe0f78034512e5))
* **settings:** add provider token configuration for Claude Code and Codex ([#623](https://github.com/croll83/companion/issues/623)) ([a555985](https://github.com/croll83/companion/commit/a5559854b55b9605a0203a1ac07a998696487ddf))
* **settings:** add public URL config + guided Linear webhook setup ([#478](https://github.com/croll83/companion/issues/478)) ([18f08d3](https://github.com/croll83/companion/commit/18f08d35ea412c5a81f0918197ea23a90f485a97))
* **sidebar:** add external links to docs, GitHub, and website ([#468](https://github.com/croll83/companion/issues/468)) ([6fe561e](https://github.com/croll83/companion/commit/6fe561e83fbdd90359bee7bf76587256b35d0704))
* **sidebar:** group sound and alerts under notification ([#203](https://github.com/croll83/companion/issues/203)) ([0077e75](https://github.com/croll83/companion/commit/0077e75208e7505a53db8a829a9480a77b8c3916))
* **sidebar:** redesign footer nav from grid to vertical list ([#470](https://github.com/croll83/companion/issues/470)) ([8fdd9f6](https://github.com/croll83/companion/commit/8fdd9f6b1b91e5cb311abfd46ee122358c2cd553))
* **sidebar:** redesign left sidebar navigation and sessions list ([#365](https://github.com/croll83/companion/issues/365)) ([000a748](https://github.com/croll83/companion/commit/000a7483c4fe7ad1df9dc8b1fa98ff0740c1c303))
* **sidebar:** redesign session items with status-first layout ([#368](https://github.com/croll83/companion/issues/368)) ([7287cfc](https://github.com/croll83/companion/commit/7287cfcb54cadbc35f1dff2ea7f0e42042b89124))
* **skills:** add new skills for design enhancement and adaptation ([a1643c4](https://github.com/croll83/companion/commit/a1643c4d4713168375c4dc4360be91d3903766ad))
* **task-panel:** redesign context panel with collapsible sections, design tokens, and accessibility ([#576](https://github.com/croll83/companion/issues/576)) ([a95145d](https://github.com/croll83/companion/commit/a95145d750fcb4272846373f4b93613cc1a84647))
* **telemetry:** add posthog analytics, opt-out controls, and CI env wiring ([#238](https://github.com/croll83/companion/issues/238)) ([743aeab](https://github.com/croll83/companion/commit/743aeab86aa5b9141c86f605bbd3572694c80113))
* **terminal:** add quick session terminal tabs for host and docker ([#299](https://github.com/croll83/companion/issues/299)) ([e4dfc51](https://github.com/croll83/companion/commit/e4dfc5141c54a898b0a5d4583ef3733b23a7d25d))
* The Vibe Companion complete web UI rewrite + npm package ([#23](https://github.com/croll83/companion/issues/23)) ([0bdc77a](https://github.com/croll83/companion/commit/0bdc77a81b21cd9d08ba29ea48844e73df3a1852))
* **ui:** add ActivityTray floating component for background agents and tasks ([#638](https://github.com/croll83/companion/issues/638)) ([abdfb4b](https://github.com/croll83/companion/commit/abdfb4bc7e096e810bde30b3cac844ceb2d8f469))
* **ui:** add compacting context indicator in message feed ([#462](https://github.com/croll83/companion/issues/462)) ([9bfab3c](https://github.com/croll83/companion/commit/9bfab3c8786d0273da0bb247c3f6bcd71028608c))
* **ui:** add full-screen session launch overlay ([#287](https://github.com/croll83/companion/issues/287)) ([0f31196](https://github.com/croll83/companion/commit/0f3119629de91271a0f3d92da2124f5028fe543b))
* **ui:** add reconnection indicator for CLI sessions ([#593](https://github.com/croll83/companion/issues/593)) ([cbaba1d](https://github.com/croll83/companion/commit/cbaba1de28cfdaaa32a6b2acc35e9de651c3daab))
* **ui:** enhanced tool rendering, tool_progress, and Codex session details ([#264](https://github.com/croll83/companion/issues/264)) ([a12963c](https://github.com/croll83/companion/commit/a12963cd014643fdd6785b03ad9e57016c1f7219))
* **ui:** make right sidebar modular with inline configuration ([#345](https://github.com/croll83/companion/issues/345)) ([a9a7905](https://github.com/croll83/companion/commit/a9a7905374e2dcf0c173b3fa9f04a7f209f75a6f))
* **ui:** show session name in top bar ([#228](https://github.com/croll83/companion/issues/228)) ([a9dc926](https://github.com/croll83/companion/commit/a9dc926d761c2dbbef741a2e7b05ecba29bd29b8))
* **update:** add Docker image update dialog after app update ([#526](https://github.com/croll83/companion/issues/526)) ([7b18479](https://github.com/croll83/companion/commit/7b184796a2b33113fa0fe159e1a96e6de36673f0))
* **web:** adaptive server-side PR polling with WebSocket push ([#178](https://github.com/croll83/companion/issues/178)) ([57939e4](https://github.com/croll83/companion/commit/57939e4030a4b0e5a7dae39d93c34944e3bdff0f))
* **web:** add @ mention prompt support to home page input ([#419](https://github.com/croll83/companion/issues/419)) ([94dbb4e](https://github.com/croll83/companion/commit/94dbb4e4d44317aa823125678b6210f5c6adee96))
* **web:** add auth, PWA, process panel, editor/files, page redesigns, and theme polish ([#396](https://github.com/croll83/companion/issues/396)) ([cb2f101](https://github.com/croll83/companion/commit/cb2f101d7c2764fbaa0d582ed1022763706c9283))
* **web:** add browser web notifications ([#191](https://github.com/croll83/companion/issues/191)) ([092c59a](https://github.com/croll83/companion/commit/092c59aff620aa2b2eac51903c01ad7cb0c4bc8e))
* **web:** add Claude Opus 4.7 to model list ([242e44b](https://github.com/croll83/companion/commit/242e44be627118f8d2897ebfd22662ffa6f9c278))
* **web:** add CLAUDE.md editor button in TopBar ([#170](https://github.com/croll83/companion/issues/170)) ([f553b9b](https://github.com/croll83/companion/commit/f553b9b86842f0b47c0bf24b08903e0352b7b078))
* **web:** add Clawd-inspired pixel art logo and favicon ([#70](https://github.com/croll83/companion/issues/70)) ([b3994ef](https://github.com/croll83/companion/commit/b3994eff2eac62c3cf8f40a8c31b720c910a7601))
* **web:** add component playground and ExitPlanMode display ([#36](https://github.com/croll83/companion/issues/36)) ([e958be7](https://github.com/croll83/companion/commit/e958be780f1b6e1a8f65daedbf968cdf6ef47798))
* **web:** add create Linear issue button in context section ([#421](https://github.com/croll83/companion/issues/421)) ([22e658c](https://github.com/croll83/companion/commit/22e658c1c0c533a058887d12ebefbbee68e10d3c))
* **web:** add Docker Builder page and refactor Environment UI ([#454](https://github.com/croll83/companion/issues/454)) ([c97dc9e](https://github.com/croll83/companion/commit/c97dc9e52a49528b5e7a64bbf518c33f630d2853))
* **web:** add embedded code editor with file tree, changed files tracking, and diff view ([#81](https://github.com/croll83/companion/issues/81)) ([3ed0957](https://github.com/croll83/companion/commit/3ed095790c73edeef911ab4c73d74f1998100c5c))
* **web:** add embedded terminal in sidebar ([#175](https://github.com/croll83/companion/issues/175)) ([e711c5d](https://github.com/croll83/companion/commit/e711c5d5ef40edfa9c265642383a4c526b9b3ece))
* **web:** add git worktree support for isolated multi-branch sessions ([#64](https://github.com/croll83/companion/issues/64)) ([fee39d6](https://github.com/croll83/companion/commit/fee39d62986cd99700ba78c84a1f586331955ff8))
* **web:** add GitHub PR status to TaskPanel sidebar ([#166](https://github.com/croll83/companion/issues/166)) ([6ace3b2](https://github.com/croll83/companion/commit/6ace3b2944ec9e9082a11a45fe0798f0f5f41e55))
* **web:** add missing message-flow components to Playground ([#156](https://github.com/croll83/companion/issues/156)) ([ef6c27d](https://github.com/croll83/companion/commit/ef6c27dfa950c11b09394c74c4452c0b02aed8fb))
* **web:** add notification sound on task completion ([#99](https://github.com/croll83/companion/issues/99)) ([337c735](https://github.com/croll83/companion/commit/337c735e8267f076ada4b9ef01632d37376ec2d0))
* **web:** add OpenAI Codex CLI backend integration ([#100](https://github.com/croll83/companion/issues/100)) ([54e3c1a](https://github.com/croll83/companion/commit/54e3c1a2b359719d7983fa9ee857507e1446f505))
* **web:** add per-session usage limits with OAuth refresh and Codex support ([24ebd32](https://github.com/croll83/companion/commit/24ebd32f5ec617290b6b93e8bc76972a3b80d6a9))
* **web:** add permission suggestions and pending permission indicators ([10422c1](https://github.com/croll83/companion/commit/10422c1464b6ad4bc45eb90e6cd9ebbc0ebeac92))
* **web:** add prerelease update channel and preview CI pipeline ([#451](https://github.com/croll83/companion/issues/451)) ([6799c6f](https://github.com/croll83/companion/commit/6799c6f46124ff2da61d7612f344fbd23da9ec69))
* **web:** add PWA support for mobile home screen install ([#116](https://github.com/croll83/companion/issues/116)) ([85e605f](https://github.com/croll83/companion/commit/85e605fd758ee952e0d5b1dbc6f7065b514844a7))
* **web:** add update-available banner with auto-update for service mode ([#158](https://github.com/croll83/companion/issues/158)) ([727bd7f](https://github.com/croll83/companion/commit/727bd7fbd16557fd63ce41632592c1485e69713c))
* **web:** add usage limits display in session panel ([#97](https://github.com/croll83/companion/issues/97)) ([d29f489](https://github.com/croll83/companion/commit/d29f489ed9951d36ff45ec240410ffd8ffdf05eb))
* **web:** archive sessions instead of deleting them ([#56](https://github.com/croll83/companion/issues/56)) ([489d608](https://github.com/croll83/companion/commit/489d6087fc99b9131386547edaf3bd303a114090))
* **web:** enlarge homepage logo as hero element ([#71](https://github.com/croll83/companion/issues/71)) ([18ead74](https://github.com/croll83/companion/commit/18ead7436d3ebbe9d766754ddb17aa504c63703f))
* **web:** git fetch on branch picker open ([#72](https://github.com/croll83/companion/issues/72)) ([f110405](https://github.com/croll83/companion/commit/f110405edbd0f00454edd65ed72197daf0293182))
* **web:** git info display, folder dropdown fix, dev workflow ([#43](https://github.com/croll83/companion/issues/43)) ([1fe2069](https://github.com/croll83/companion/commit/1fe2069a7db17b410e383f883c934ee1662c2171))
* **web:** git worktree support with branch picker and git pull ([#65](https://github.com/croll83/companion/issues/65)) ([4d0c9c8](https://github.com/croll83/companion/commit/4d0c9c83f4fe13be863313d6c945ce0b671a7f8a))
* **web:** group sidebar sessions by project directory ([#117](https://github.com/croll83/companion/issues/117)) ([deceb59](https://github.com/croll83/companion/commit/deceb599975f53141e9c0bd6c7675437f96978b8))
* **web:** implement AI validation mode for permission requests ([#420](https://github.com/croll83/companion/issues/420)) ([3436175](https://github.com/croll83/companion/commit/3436175dfb66810584ef168ad943f0e47086623d))
* **web:** improve streaming reliability and session branching controls ([#381](https://github.com/croll83/companion/issues/381)) ([200ab34](https://github.com/croll83/companion/commit/200ab34f42969e09c1a1e9bbb0ba6df44b791a6e))
* **web:** increase recorder max lines from 100k to 1M ([#426](https://github.com/croll83/companion/issues/426)) ([cf7a70b](https://github.com/croll83/companion/commit/cf7a70bf107722c48c784d8ca829196171ef27e3))
* **web:** make AI validation configurable per session ([#428](https://github.com/croll83/companion/issues/428)) ([bfec31a](https://github.com/croll83/companion/commit/bfec31a29e15441e1e3c251752d4570b6950692f))
* **web:** make saved prompts targetable by project scope or global ([#448](https://github.com/croll83/companion/issues/448)) ([805eb73](https://github.com/croll83/companion/commit/805eb73c7f3138a6feb5ad33a485dc60d9364a0a))
* **web:** move git fetch/checkout/pull inside Docker container ([#422](https://github.com/croll83/companion/issues/422)) ([02b22fa](https://github.com/croll83/companion/commit/02b22fa57dab59d95bf3a812c6800a1cdd121975))
* **web:** move git fetch/checkout/pull inside Docker container ([#424](https://github.com/croll83/companion/issues/424)) ([8559dcf](https://github.com/croll83/companion/commit/8559dcf49a23d1969b17907f33c4ffcf91205f63))
* **web:** named environment profiles (~/.companion/envs/) ([#50](https://github.com/croll83/companion/issues/50)) ([eaa1a49](https://github.com/croll83/companion/commit/eaa1a497f3be61f2f71f9467e93fa2b65be19095))
* **web:** persist sessions to disk for dev mode resilience ([#45](https://github.com/croll83/companion/issues/45)) ([c943d00](https://github.com/croll83/companion/commit/c943d0047b728854f059e26facde950e08cdfe0c))
* **web:** prompt to transition Linear issue status on session archive ([#441](https://github.com/croll83/companion/issues/441)) ([e8ed5bd](https://github.com/croll83/companion/commit/e8ed5bd4a3b30f20dcd7e10d64f834752bed8b37))
* **web:** redesign session list with avatars, auto-reconnect, and git info ([#111](https://github.com/croll83/companion/issues/111)) ([8a7284b](https://github.com/croll83/companion/commit/8a7284b3c08dc301a879924aea133945697b037a))
* **web:** replace CodeMirror editor with unified diff viewer ([#160](https://github.com/croll83/companion/issues/160)) ([f9b6869](https://github.com/croll83/companion/commit/f9b686902011ffd194a118cc1cb022bac71eaa3b))
* **web:** replace folder picker dropdown with fixed-size modal ([#76](https://github.com/croll83/companion/issues/76)) ([979e395](https://github.com/croll83/companion/commit/979e395b530cdb21e6a073ba60e33ea8ac497e2a))
* **web:** replace OpenRouter by Anthropic for AI features ([#439](https://github.com/croll83/companion/issues/439)) ([40d794c](https://github.com/croll83/companion/commit/40d794c24f90cd31628a362c960ad135877326e9))
* **web:** session rename persistence + auto-generated titles ([#79](https://github.com/croll83/companion/issues/79)) ([e1dc58c](https://github.com/croll83/companion/commit/e1dc58ce8ab9a619d36f2261cce89b90cfdb70d6))
* **web:** warn when branch is behind remote before session creation ([#127](https://github.com/croll83/companion/issues/127)) ([ef89d5c](https://github.com/croll83/companion/commit/ef89d5c208ca5da006aaa88b78dbd647186fb0df))


### Bug Fixes

* add Windows compatibility for binary resolution and process spawning ([#510](https://github.com/croll83/companion/issues/510)) ([79573af](https://github.com/croll83/companion/commit/79573af1243a74586f56b1cc5fd4558f76c2c69e))
* **agents:** add resilient webhook copy URL behavior ([#400](https://github.com/croll83/companion/issues/400)) ([07bbf9b](https://github.com/croll83/companion/commit/07bbf9b8e63ec9e20f0bb4ac52fd6d0d18614f71))
* **agents:** make webhook secret field editable for Linear/GitHub ([#485](https://github.com/croll83/companion/issues/485)) ([b3460db](https://github.com/croll83/companion/commit/b3460db75b5bec4ea116f41ea83e710c79566751))
* **agents:** replace emoji icons with SVG icon system ([#406](https://github.com/croll83/companion/issues/406)) ([d2ed31b](https://github.com/croll83/companion/commit/d2ed31b477e07d7f8d17e2a19c01599b45e05f69))
* always update statusLine settings on agent spawn ([#21](https://github.com/croll83/companion/issues/21)) ([71c343c](https://github.com/croll83/companion/commit/71c343cfd29fff3204ad0cc2986ff000d1be5adc))
* capture the return value and return early if the copy did not succeed. ([4762104](https://github.com/croll83/companion/commit/4762104f4ba3f8acbec57bd0125f98893a73b783))
* checkout selected branch when worktree mode is off ([#68](https://github.com/croll83/companion/issues/68)) ([500f3b1](https://github.com/croll83/companion/commit/500f3b112c5ccc646c7965344b5774efe1338377))
* **ci:** only tag Docker image as :latest on version tags ([63ca679](https://github.com/croll83/companion/commit/63ca67934ab6d4a9024f5aa6031b4e059baeca79))
* **ci:** rewrite coverage gate to enforce 80% on new/changed files ([#399](https://github.com/croll83/companion/issues/399)) ([e257897](https://github.com/croll83/companion/commit/e257897674024a5cad12f3468c73a7e2f9d7c799))
* **ci:** use bun run test instead of bun test in preview workflow ([#452](https://github.com/croll83/companion/issues/452)) ([f2e2f10](https://github.com/croll83/companion/commit/f2e2f10b7f74c9fb3126c9c9d2be1c74b43a3bf9))
* **ci:** use patch-core bump for preview npm versions (THE-216) ([#456](https://github.com/croll83/companion/issues/456)) ([c3c1115](https://github.com/croll83/companion/commit/c3c11156b33e2a5549293365d32107ccf93c8d51))
* **claude-adapter:** drop CLI user echo messages to prevent raw JSON in chat UI ([#592](https://github.com/croll83/companion/issues/592)) ([3368136](https://github.com/croll83/companion/commit/33681360e09c056f1e9f50d039209a5ce85ffc8b))
* **claude-adapter:** re-apply user echo drop fix reverted by [#589](https://github.com/croll83/companion/issues/589) ([#605](https://github.com/croll83/companion/issues/605)) ([ee65392](https://github.com/croll83/companion/commit/ee653928150ce7877d2baf79230dafbc5c9e3f84))
* **cli-launcher:** bypass shebang to use correct Node for Codex ([#223](https://github.com/croll83/companion/issues/223)) ([9fe1583](https://github.com/croll83/companion/commit/9fe158358880789ec80ea5bd5daf738a261089dc))
* **cli-launcher:** pass enriched PATH to spawned CLI/Codex processes ([#221](https://github.com/croll83/companion/issues/221)) ([661e8b4](https://github.com/croll83/companion/commit/661e8b45d9909b9e59b0ecb396a4fb7a143f2816))
* **cli-launcher:** use 127.0.0.1 in --sdk-url; add optional JSON-handoff bridge mode ([#655](https://github.com/croll83/companion/issues/655)) ([664f165](https://github.com/croll83/companion/commit/664f165042d8eb3d1ccc90bf11272258342dc685))
* **cli:** auto-update restarts service reliably via explicit systemctl/launchctl ([#208](https://github.com/croll83/companion/issues/208)) ([33fa67e](https://github.com/croll83/companion/commit/33fa67ebd75609b9a7b8700ce67b1dd949663b06))
* **cli:** expose stop/restart in help and add test ([#188](https://github.com/croll83/companion/issues/188)) ([c307525](https://github.com/croll83/companion/commit/c30752545f2137fd7c03525d5bb7f5f8851271d4))
* **cli:** fix Linux systemd service management (start, auto-restart) ([#213](https://github.com/croll83/companion/issues/213)) ([fc1dd65](https://github.com/croll83/companion/commit/fc1dd65a9fd32958d47499af1b35992a0c10fe8e))
* **cli:** refresh systemd unit file on start/restart to prevent restart loops ([#215](https://github.com/croll83/companion/issues/215)) ([35f80d9](https://github.com/croll83/companion/commit/35f80d963b1f0f0feccf7215a9bd4711b4520a12))
* **cli:** resolve binaries via user shell PATH when running as service ([#216](https://github.com/croll83/companion/issues/216)) ([47e4967](https://github.com/croll83/companion/commit/47e4967215a5bfd84c8afc2a86ce42151c73d187))
* **codex:** auto-relaunch session when transport drops with browsers connected ([#484](https://github.com/croll83/companion/issues/484)) ([c0ec63b](https://github.com/croll83/companion/commit/c0ec63be8e9e1814e33eef2fc9b58da1b09e06b7))
* **codex:** fall back to thread/start when thread/resume fails on session restart ([#524](https://github.com/croll83/companion/issues/524)) ([36e4179](https://github.com/croll83/companion/commit/36e41794e8aef968786021a03e688802710c5e51))
* **codex:** fix 3 critical bugs in Codex backend integration ([#147](https://github.com/croll83/companion/issues/147)) ([0ec92db](https://github.com/croll83/companion/commit/0ec92db909c7be42f94cc21d2890c9c123702dd7))
* **codex:** handle init failure gracefully and isolate per-session CODEX_HOME ([#210](https://github.com/croll83/companion/issues/210)) ([f4efcea](https://github.com/croll83/companion/commit/f4efceace6c260de92df728335678b7bded3e144))
* **codex:** handle unhandled Codex notification methods to prevent protocol drift warnings ([#637](https://github.com/croll83/companion/issues/637)) ([e0c242d](https://github.com/croll83/companion/commit/e0c242dd1b0c94ff5ddbf3f8e7e706ce6d5cd506))
* **codex:** handle WS reconnection and idle kill for Codex sessions ([#530](https://github.com/croll83/companion/issues/530)) ([f26a6b8](https://github.com/croll83/companion/commit/f26a6b809d4671ec1dd2716e312a007ec0da83cd))
* **codex:** harden connection resilience and error recovery ([#569](https://github.com/croll83/companion/issues/569)) ([b71281e](https://github.com/croll83/companion/commit/b71281e4ded9bc62be52c57b4bc8497a92fc10cc))
* **codex:** harden reconnect message delivery and ws port allocation ([#557](https://github.com/croll83/companion/issues/557)) ([de9d3f5](https://github.com/croll83/companion/commit/de9d3f5f4a3a17f02cd8eb3d6969d706de50933c))
* **codex:** improve reconnection reliability and prevent message loss ([#584](https://github.com/croll83/companion/issues/584)) ([273f86d](https://github.com/croll83/companion/commit/273f86da9e7c0267aa705c0b52e640dc4a02cf6a))
* **codex:** increase WS timeouts and auto-relaunch on RPC timeout ([#514](https://github.com/croll83/companion/issues/514)) ([2fcccf3](https://github.com/croll83/companion/commit/2fcccf39d72a59bc674b41e7d912297c3afce4eb))
* **codex:** normalize rate-limit reset timestamps ([#386](https://github.com/croll83/companion/issues/386)) ([f361696](https://github.com/croll83/companion/commit/f3616960e48dcddccc48c956621c819568157e49))
* **codex:** preserve parent id in task tool-use backfill ([#447](https://github.com/croll83/companion/issues/447)) ([a208ee4](https://github.com/croll83/companion/commit/a208ee42e09209866be39940c6fb2d480d9ecc5a))
* **codex:** prevent double disconnect callback and increase reconnect retries ([#567](https://github.com/croll83/companion/issues/567)) ([1dbc219](https://github.com/croll83/companion/commit/1dbc219a66f9ec85398c9efcaf5bc7b448bc4942))
* **codex:** resolve four stability issues breaking Codex sessions ([#562](https://github.com/croll83/companion/issues/562)) ([a978ab1](https://github.com/croll83/companion/commit/a978ab11269a01ef45d70204729aac526c212c6e))
* **codex:** resolve transport disconnect race causing stuck sessions on page refresh ([#595](https://github.com/croll83/companion/issues/595)) ([dd79e21](https://github.com/croll83/companion/commit/dd79e213d9cb6f04a920faa108a2af862728ecd1))
* **codex:** resolve WebSocket reconnect and message sync issues ([#564](https://github.com/croll83/companion/issues/564)) ([f1e0041](https://github.com/croll83/companion/commit/f1e0041fea0502c8679f320ab0d8adb186c8c35e))
* **codex:** use container cwd for docker runtime context ([#313](https://github.com/croll83/companion/issues/313)) ([ba6347b](https://github.com/croll83/companion/commit/ba6347ba90e93ba3e750b13b8687b7e428484725))
* **containers:** rewrite SSH git remotes to HTTPS inside containers ([6c867e3](https://github.com/croll83/companion/commit/6c867e36cc7b76a94c59e646ba37813b4aea651b))
* **containers:** switch Docker registry from ghcr.io to Docker Hub ([525687e](https://github.com/croll83/companion/commit/525687e3e6d4eae3ab1125599c62881ee0ce80ac))
* **copy-button:** always-visible on mobile + add message-level copy ([5ffec24](https://github.com/croll83/companion/commit/5ffec245a49098133e44e783b817bff9e0de4aaa))
* **CopyButton:** check execCommand return value before showing success ([4762104](https://github.com/croll83/companion/commit/4762104f4ba3f8acbec57bd0125f98893a73b783))
* **docker:** preserve containers on idle-kill and increase default timeout to 24h ([#602](https://github.com/croll83/companion/issues/602)) ([7f5eab2](https://github.com/croll83/companion/commit/7f5eab2924686b3cbfebf1abf94951a361a13d13))
* **docker:** propagate host git identity into containers ([#310](https://github.com/croll83/companion/issues/310)) ([81be828](https://github.com/croll83/companion/commit/81be828db84efb74772ef4cb89d4d83fc5b4e9f5))
* **docker:** remove legacy companion-dev image support ([#295](https://github.com/croll83/companion/issues/295)) ([fe8cc2a](https://github.com/croll83/companion/commit/fe8cc2a57390a5ccd5e2d18605995c043cfa26b4))
* **docs:** update mintlify docs.json schema ([265c89e](https://github.com/croll83/companion/commit/265c89eb3480974458dc7e0ad135a1fbb5b306b3))
* **editor:** replace vscode tab with codemirror behind settings ([#372](https://github.com/croll83/companion/issues/372)) ([52bc626](https://github.com/croll83/companion/commit/52bc626fdb1a27a06c2e13a2ef6aa59a4f0da9f9))
* **home:** eliminate layout shifts on homepage input ([#577](https://github.com/croll83/companion/issues/577)) ([0a5832a](https://github.com/croll83/companion/commit/0a5832a591930b4b78f718c501d30c25e8555811))
* **homepage:** restore linear issue branch auto-selection ([#342](https://github.com/croll83/companion/issues/342)) ([01936e4](https://github.com/croll83/companion/commit/01936e4de89bd925c71d13034c91c95560b5e517))
* **integrations:** refine linear settings flow and home card UX ([#328](https://github.com/croll83/companion/issues/328)) ([443b3ec](https://github.com/croll83/companion/commit/443b3ecef48565f13d27c0a913d4504d1d0ef66e))
* **keepalive:** add Codex disconnect debounce and enable headless proactive keepalive ([#635](https://github.com/croll83/companion/issues/635)) ([a0d4e52](https://github.com/croll83/companion/commit/a0d4e5263820fefc2bb6beaf6aeb1903052b568d))
* **landing:** focus messaging on codex, mcp, terminal and secure remote setup ([#237](https://github.com/croll83/companion/issues/237)) ([80759a7](https://github.com/croll83/companion/commit/80759a7ed3209d8aebf1e108d3e0c68d7bb8824f))
* **linear:** add server-side cache to prevent API rate limiting ([#352](https://github.com/croll83/companion/issues/352)) ([843b585](https://github.com/croll83/companion/commit/843b5857a3aefd5ee304fa05aa60fa09d8add1b9))
* **linear:** log webhook acceptance and rejection ([#612](https://github.com/croll83/companion/issues/612)) ([08e495b](https://github.com/croll83/companion/commit/08e495b3ac06323d1113a43328682deedeac373d))
* **linear:** refresh OAuth configured state after saving credentials ([#495](https://github.com/croll83/companion/issues/495)) ([db5998a](https://github.com/croll83/companion/commit/db5998a2752f0188432d4c726dc8d1fbc8768cca))
* **linear:** show only active issues and prioritize backlog ([#346](https://github.com/croll83/companion/issues/346)) ([c2a6e1a](https://github.com/croll83/companion/commit/c2a6e1a0b8d22d032b516a186d5e23db906fdfc2))
* **linear:** thread connectionId through CreateIssueModal for multi-connection support ([#498](https://github.com/croll83/companion/issues/498)) ([ccb8881](https://github.com/croll83/companion/commit/ccb8881066bafe9664f7cf3822f528d840499df1))
* make service stop actually stop on macOS and refresh stale update checks ([#192](https://github.com/croll83/companion/issues/192)) ([f608f64](https://github.com/croll83/companion/commit/f608f64887bf78b2cca909aa20bd87e4a897ce94))
* **model-switch:** kill+relaunch CLI when user changes model ([a775a7f](https://github.com/croll83/companion/commit/a775a7f5f48cba3ffd7e4e5037ddd00156b01130))
* **orchestrator,ws-bridge:** prevent mass session relaunch on restart ([3da3339](https://github.com/croll83/companion/commit/3da3339d7f2029cf07c6a55d81624417cd9ffaa4))
* **orchestrator:** disable proactive keepalive to prevent RAM exhaustion ([d370b03](https://github.com/croll83/companion/commit/d370b0376c6c2e934c9afa7737e2cfd1b977f754))
* **orchestrator:** prevent PID recycling from blocking Docker session relaunch ([#589](https://github.com/croll83/companion/issues/589)) ([5e76c50](https://github.com/croll83/companion/commit/5e76c50051f70efa0bd827b3ae252e48d3afa0d1))
* prevent WebSocket connection cycling and output replay ([#494](https://github.com/croll83/companion/issues/494)) ([91e2a22](https://github.com/croll83/companion/commit/91e2a22c039973e63031ebc8dcbdd92323254d8a))
* **prompts:** expand prompt editor workspace ([#640](https://github.com/croll83/companion/issues/640)) ([5288314](https://github.com/croll83/companion/commit/52883144858f62d6f9b418c00432279f28d119d4))
* **protocol:** surface backend protocol drift early ([#559](https://github.com/croll83/companion/issues/559)) ([dc43fb9](https://github.com/croll83/companion/commit/dc43fb9ad285dba8a1e13f1f56566d32690a5f96))
* remove vibe alias, update repo URLs to companion ([#30](https://github.com/croll83/companion/issues/30)) ([4f7b47c](https://github.com/croll83/companion/commit/4f7b47cba86c278e89fe81292fea9b8b3e75c035))
* **repo:** add tailored greptile code review rules ([#258](https://github.com/croll83/companion/issues/258)) ([2030e55](https://github.com/croll83/companion/commit/2030e553015800b757716393ada8fe2b1527f5bf))
* scope permission requests to their session tab ([#35](https://github.com/croll83/companion/issues/35)) ([ef9f41c](https://github.com/croll83/companion/commit/ef9f41c8589e382de1db719984931bc4e91aeb11))
* **server:** base new branches on origin/{defaultBranch} instead of stale local ref ([#334](https://github.com/croll83/companion/issues/334)) ([0a736f4](https://github.com/croll83/companion/commit/0a736f4f224db0a79aaca329a70f24f7b7e1b5e7))
* **server:** map container repo root to host path ([#348](https://github.com/croll83/companion/issues/348)) ([c29f967](https://github.com/croll83/companion/commit/c29f9671d4dcdda876a999906f0e6fd63da8bd27))
* **server:** prevent settings undefined overwrite crash ([#327](https://github.com/croll83/companion/issues/327)) ([9173ee2](https://github.com/croll83/companion/commit/9173ee2ed959a6333fb180d3e34f4deaa180c0d9))
* **server:** resolve branch from containerized session git state ([#340](https://github.com/croll83/companion/issues/340)) ([304092d](https://github.com/croll83/companion/commit/304092df1c2e3ce8eceaa3c2c39917beb94b2cdb))
* **server:** support usage limits on Linux and Docker ([#540](https://github.com/croll83/companion/issues/540)) ([70e5d4e](https://github.com/croll83/companion/commit/70e5d4e51ad699a45cae89c1288d7f6101889b17))
* **session:** fetch remote refs before worktree branch creation (THE-218) ([#460](https://github.com/croll83/companion/issues/460)) ([0050884](https://github.com/croll83/companion/commit/0050884dc07c3ec04a373be388e85f1ca28c2b97))
* **settings:** correct Anthropic model ID from claude-sonnet-4.6 to claude-sonnet-4-6 ([#503](https://github.com/croll83/companion/issues/503)) ([186aa77](https://github.com/croll83/companion/commit/186aa77c631a5d0c96ce96d41b7342e28b3b7024))
* **settings:** correct auto-renaming helper copy ([#230](https://github.com/croll83/companion/issues/230)) ([5da1586](https://github.com/croll83/companion/commit/5da15865508e6ae5bbcda45e149f64bc966b141c))
* **settings:** disable auto-deny dangerous tools by default ([#513](https://github.com/croll83/companion/issues/513)) ([4c9be30](https://github.com/croll83/companion/commit/4c9be30104dea84462daca03f52d079d697e2859))
* **settings:** open update overlay on update restart ([#356](https://github.com/croll83/companion/issues/356)) ([2c7989e](https://github.com/croll83/companion/commit/2c7989ee8242c95eebced7cc712a0191271f79e9))
* show pasted images in chat history ([#32](https://github.com/croll83/companion/issues/32)) ([46365be](https://github.com/croll83/companion/commit/46365be45ae8b325100ed296617455c105d4d52e))
* **sidebar:** nest notification toggles behind disclosure ([#207](https://github.com/croll83/companion/issues/207)) ([87e71b8](https://github.com/croll83/companion/commit/87e71b8f5bf3e47c96421bca315ac412934a7dc2))
* **sidebar:** prevent hover overlay and restore archived click ([#370](https://github.com/croll83/companion/issues/370)) ([56abbc1](https://github.com/croll83/companion/commit/56abbc1ca11b5ff34d0a2c1350740d697640b6d9))
* **sidebar:** reconcile client sessions with server on poll ([#621](https://github.com/croll83/companion/issues/621)) ([177af4b](https://github.com/croll83/companion/commit/177af4be321411dad1c1fe3683fd805e6beaa06c))
* **sidebar:** separate scheduled runs from regular sessions ([#284](https://github.com/croll83/companion/issues/284)) ([cc0f042](https://github.com/croll83/companion/commit/cc0f042472363e40410728c550a7e6e2275ab80b))
* **tailscale:** add operator mode detection + DNS reachability checks ([#483](https://github.com/croll83/companion/issues/483)) ([d7a1460](https://github.com/croll83/companion/commit/d7a1460ac0864c7970970fcfcc0d8c7e1237eff2))
* **task-panel:** enable scrolling for long MCP sections ([#204](https://github.com/croll83/companion/issues/204)) ([b98abbb](https://github.com/croll83/companion/commit/b98abbbea4355c7e91d4dc322e53e638f4e4c542))
* **tests:** stabilize SessionEditorPane refresh assertion ([#466](https://github.com/croll83/companion/issues/466)) ([c244ed8](https://github.com/croll83/companion/commit/c244ed86b5144a8ab1b3729be208fe5ba6278b9f))
* **test:** stabilize system process expansion assertion ([c73da13](https://github.com/croll83/companion/commit/c73da13c8bbac783d5f5292e9ea31dc838dc63f3))
* **topbar:** hide context button on home page ([#317](https://github.com/croll83/companion/issues/317)) ([e5152e5](https://github.com/croll83/companion/commit/e5152e573ffc43ee5ad9aecc7bd76c937dd03d79))
* **topbar:** improve diff badge contrast in dark mode ([#359](https://github.com/croll83/companion/issues/359)) ([a995aa1](https://github.com/croll83/companion/commit/a995aa1568576905c6b6e9702b5b5f5cc3ca4527))
* **topbar:** prevent Session tab from being clipped on Android ([#581](https://github.com/croll83/companion/issues/581)) ([ee231c5](https://github.com/croll83/companion/commit/ee231c558bfb826942a3d96ce9c2c7b81ffb0043))
* **topbar:** sample active tab color from underlying surface ([#315](https://github.com/croll83/companion/issues/315)) ([ebce0ec](https://github.com/croll83/companion/commit/ebce0ec12b5280ac46a8b63b4511202801009fcc))
* track all commits in release-please, not just web/ ([#27](https://github.com/croll83/companion/issues/27)) ([d49f649](https://github.com/croll83/companion/commit/d49f64996d02807baf0482ce3c3607ae59f78638))
* **ui:** address review comments - stray 0 render, concurrent progress clearing ([#265](https://github.com/croll83/companion/issues/265)) ([6dfdee0](https://github.com/croll83/companion/commit/6dfdee0dbd25bc896e2c3ef37727021130da1808))
* **ui:** cap textarea height and add overflow scroll for long prompts ([#285](https://github.com/croll83/companion/issues/285)) ([2b26bc7](https://github.com/croll83/companion/commit/2b26bc7b4122d22d29c821d9e1db29cce7dfbc64))
* **ui:** dock session terminal inside workspace and prioritize docker target ([#302](https://github.com/croll83/companion/issues/302)) ([b3f0dd4](https://github.com/croll83/companion/commit/b3f0dd4196af53fd05fd8c432afdc40547a3f2c9))
* **ui:** hide Linear context bar when Linear is not configured ([#339](https://github.com/croll83/companion/issues/339)) ([cd4f55f](https://github.com/croll83/companion/commit/cd4f55f83d9ca166368680c6303c93c3b354f782))
* **ui:** improve thinking, tool results, and question prompts ([#321](https://github.com/croll83/companion/issues/321)) ([5c3dd7c](https://github.com/croll83/companion/commit/5c3dd7c501bc23b52c56fee6d5a3995545f8730b))
* **ui:** keep session action controls visible on mobile ([#247](https://github.com/croll83/companion/issues/247)) ([209ac9a](https://github.com/croll83/companion/commit/209ac9a3f2d5bd99e3e2dbe46dc9eb7b10e40082))
* **ui:** limit auto-approve notifications to one with dismiss button ([#504](https://github.com/croll83/companion/issues/504)) ([6fb15a0](https://github.com/croll83/companion/commit/6fb15a0ebe1790cef1368dc80af0a9eb0da6c7d1))
* **ui:** move terminal, settings, and environments to full pages ([#224](https://github.com/croll83/companion/issues/224)) ([be1de35](https://github.com/croll83/companion/commit/be1de35e816ac782d4ba5c948f0b00abf0641f75))
* **ui:** redesign chat blocks inline and fix streaming message duplication ([#597](https://github.com/croll83/companion/issues/597)) ([6735a9a](https://github.com/croll83/companion/commit/6735a9a6482c650c36ffb280448a00148f1c8b12))
* **update:** add full-screen overlay with auto-refresh after update ([#349](https://github.com/croll83/companion/issues/349)) ([f988b14](https://github.com/croll83/companion/commit/f988b142ea5458cb6654211a24e7cd02d7ee02da))
* use correct secret name NPM_PUBLISH_TOKEN in publish workflow ([e296ab0](https://github.com/croll83/companion/commit/e296ab0fabd6345b1f21c7094ca1f8d6f6af79cb))
* use correct secret name NPM_PUBLISH_TOKEN in publish workflow ([#26](https://github.com/croll83/companion/issues/26)) ([61eed5a](https://github.com/croll83/companion/commit/61eed5addd6e332fac360d9ae8239f1b0f93868e))
* use random suffixes for worktree branch names ([#88](https://github.com/croll83/companion/issues/88)) ([0b79f9a](https://github.com/croll83/companion/commit/0b79f9af172595cb84810b5d4cd65e0ed9c8e23d))
* **web:** add auth header to UpdateOverlay server poll ([#410](https://github.com/croll83/companion/issues/410)) ([86e26cb](https://github.com/croll83/companion/commit/86e26cb0a3983b5c5c39aa3a60276bdedf17629a))
* **web:** always generate unique branch names for worktrees with forceNew ([#131](https://github.com/croll83/companion/issues/131)) ([cd62d4a](https://github.com/croll83/companion/commit/cd62d4ac8fae0b56cdef0ff850eab4a8c707f99b))
* **web:** broadcast session name update on manual rename ([#427](https://github.com/croll83/companion/issues/427)) ([e3479b8](https://github.com/croll83/companion/commit/e3479b8ca0018014f6bd3121246d047ee292125e))
* **web:** chat scroll and composer visibility in plan mode ([#55](https://github.com/croll83/companion/issues/55)) ([4cff10c](https://github.com/croll83/companion/commit/4cff10cde297b7142c088584b6dd83060902c526))
* **web:** compare file diffs against default branch ([#226](https://github.com/croll83/companion/issues/226)) ([b437d2c](https://github.com/croll83/companion/commit/b437d2c5705ee32cb4e7964dd1d33113d3470f9d))
* **web:** decouple Saved Prompts page from session cwd and add grouped view ([#450](https://github.com/croll83/companion/issues/450)) ([c87cd27](https://github.com/croll83/companion/commit/c87cd2799c341ec44e760721df6a2721f0a3c1d0))
* **web:** deduplicate messages on WebSocket reconnection ([#150](https://github.com/croll83/companion/issues/150)) ([a81bb3d](https://github.com/croll83/companion/commit/a81bb3d878957f1f18234a5f9194d1d8064f795c))
* **web:** default folder picker to home directory instead of server cwd ([#122](https://github.com/croll83/companion/issues/122)) ([7b8a4c7](https://github.com/croll83/companion/commit/7b8a4c71f32c68ffcc907269e88b3711c0d5af7a))
* **web:** enable codex web search when internet toggle is on ([#135](https://github.com/croll83/companion/issues/135)) ([8d9f0b0](https://github.com/croll83/companion/commit/8d9f0b002dcafcfc020862cb107777d75fc2580e))
* **web:** fetch and pull selected branch on session create ([#137](https://github.com/croll83/companion/issues/137)) ([9cdbbe1](https://github.com/croll83/companion/commit/9cdbbe1e151f024bd41f60e20c60e2f092ba7014))
* **web:** fix Codex approval policy and Composer mode labels ([#106](https://github.com/croll83/companion/issues/106)) ([fd5c2f1](https://github.com/croll83/companion/commit/fd5c2f15b144eb2ae9ec809fdb6ee19e797dc15a))
* **web:** fix Codex session reconnection Transport closed errors ([#431](https://github.com/croll83/companion/issues/431)) ([c559f79](https://github.com/croll83/companion/commit/c559f7910c4d18b83b343af99ef7c932e66cce66))
* **web:** fix plan display colors broken in light mode ([#417](https://github.com/croll83/companion/issues/417)) ([90f6e81](https://github.com/croll83/companion/commit/90f6e8182af098027610bc89481bb7c87c0038f3))
* **web:** fix session auto-rename and add blur-to-focus animation ([#86](https://github.com/croll83/companion/issues/86)) ([6d3c91f](https://github.com/croll83/companion/commit/6d3c91f73a65054e2c15727e90ca554af70eed28))
* **web:** fix WritableStream locked race condition in Codex adapter ([b43569d](https://github.com/croll83/companion/commit/b43569dbb3d154a303d60ec6bc2007b5a7bcedea))
* **web:** flush pending messages when attaching Codex adapter ([#433](https://github.com/croll83/companion/issues/433)) ([86a25ff](https://github.com/croll83/companion/commit/86a25ffde7ce7c8672367607352508bcc222b08a))
* **web:** handle Codex ExitPlanMode as dedicated permission request ([#430](https://github.com/croll83/companion/issues/430)) ([bde2d11](https://github.com/croll83/companion/commit/bde2d11b5234faa9f6889d78133ef3dc2ae182ad))
* **web:** improve light mode contrast ([#89](https://github.com/croll83/companion/issues/89)) ([7ac7886](https://github.com/croll83/companion/commit/7ac7886fc6305e3ec45698a1c7c91b72a91c7c44))
* **web:** improve responsive design across all components ([#85](https://github.com/croll83/companion/issues/85)) ([0750fbb](https://github.com/croll83/companion/commit/0750fbbbe456d79bc104fdbdaf8f08e8795a3b62))
* **web:** isolate worktree sessions with proper branch-tracking ([#74](https://github.com/croll83/companion/issues/74)) ([764d7a7](https://github.com/croll83/companion/commit/764d7a7f5391a686408a8542421f771da341d5db))
* **web:** polyfill localStorage for Node.js 22+ ([#149](https://github.com/croll83/companion/issues/149)) ([602c684](https://github.com/croll83/companion/commit/602c6841f03677ec3f419860469e39b791968de6))
* **web:** prevent Codex Docker sessions from becoming zombie/unreachable ([#449](https://github.com/croll83/companion/issues/449)) ([db947f5](https://github.com/croll83/companion/commit/db947f57989d676e1b40f44a7c7014cffb5fed19))
* **web:** prevent horizontal scroll on Android Chrome ([#443](https://github.com/croll83/companion/issues/443)) ([cc4743c](https://github.com/croll83/companion/commit/cc4743ce3112f0e523e7dd688a7ec8a008f73e57))
* **web:** prevent iOS auto-zoom on mobile input focus ([#102](https://github.com/croll83/companion/issues/102)) ([18ee23f](https://github.com/croll83/companion/commit/18ee23f6f1674fbcf5e1be25f8c4e23510bc12b5))
* **web:** prevent mobile keyboard layout shift and iOS zoom on branch selector ([#159](https://github.com/croll83/companion/issues/159)) ([4276afd](https://github.com/croll83/companion/commit/4276afd4390808d9d040555652c80bd1461c45b7))
* **web:** refresh git branch tracking after session start ([#195](https://github.com/croll83/companion/issues/195)) ([c3cb47b](https://github.com/croll83/companion/commit/c3cb47b56257b866b76abbb66709694cb26e0925))
* **web:** resolve [object Object] display for Codex file edit results ([#133](https://github.com/croll83/companion/issues/133)) ([9cc21a7](https://github.com/croll83/companion/commit/9cc21a78064cf07bb90174dd87bbfbd367516c90))
* **web:** resolve original repo root for worktree sessions in sidebar grouping ([#120](https://github.com/croll83/companion/issues/120)) ([8925ac9](https://github.com/croll83/companion/commit/8925ac9f540b3cd2520268539d21b0267b2dadb1))
* **web:** send full Linear ticket description in session prompt ([#435](https://github.com/croll83/companion/issues/435)) ([bd9745a](https://github.com/croll83/companion/commit/bd9745a81b43fccb843a32d9a842e6c04e7fb8b5))
* **web:** session reconnection with auto-relaunch and persist ([#49](https://github.com/croll83/companion/issues/49)) ([f58e542](https://github.com/croll83/companion/commit/f58e5428847a342069e6790fa7d70f190bc5f396))
* **web:** stable session ordering — sort by creation date only ([#173](https://github.com/croll83/companion/issues/173)) ([05c3a06](https://github.com/croll83/companion/commit/05c3a0652b823c5ca20b233be164a899f9920caf))
* **web:** unset CLAUDECODE env var to prevent CLI nesting guard rejec… ([#181](https://github.com/croll83/companion/issues/181)) ([75e264a](https://github.com/croll83/companion/commit/75e264a0be975dadbf3d56e64b990e0e07b12777))
* **web:** use --resume on CLI relaunch to restore conversation context ([#46](https://github.com/croll83/companion/issues/46)) ([3e2b5bd](https://github.com/croll83/companion/commit/3e2b5bdd39bd265ca5675784227a9f1b4f2a8aa3))
* **windows:** add platform guards and prefer where over which ([#512](https://github.com/croll83/companion/issues/512)) ([08464f5](https://github.com/croll83/companion/commit/08464f5e2b82153a4218ebbad10f4efdf3f0c81a))
* **workbench:** remove terminal and session extras ([#632](https://github.com/croll83/companion/issues/632)) ([9b5e675](https://github.com/croll83/companion/commit/9b5e67535233acb987f60348a7f3d90d6f76f83c))
* **ws-bridge:** broadcast permissionMode changes from CLI to browsers ([#639](https://github.com/croll83/companion/issues/639)) ([4c9dbab](https://github.com/croll83/companion/commit/4c9dbab91094d0d83a04c79681e6e153d7f17652))
* **ws-bridge:** don't auto-relaunch on browser connect ([7e778f1](https://github.com/croll83/companion/commit/7e778f19afb90ad4a153eb9e88ee7a93556955c8))
* **ws-bridge:** prevent CLI session_id from overwriting Companion ID ([#580](https://github.com/croll83/companion/issues/580)) ([bc72ff1](https://github.com/croll83/companion/commit/bc72ff1859a9a4041702bcc73685ea8964c11ed4))
* **ws-bridge:** remove all auto-relaunch from disconnect handlers ([4760d9b](https://github.com/croll83/companion/commit/4760d9b8e0a14245531a49f75e3c78ee09bd47cf))
* **ws-bridge:** repair state machine transitions and prevent memory leaks ([#590](https://github.com/croll83/companion/issues/590)) ([245a29b](https://github.com/croll83/companion/commit/245a29ba44d194211ed187180ee056a97e216e07))
* **ws:** add durable replay cursors and idempotent message handling ([#232](https://github.com/croll83/companion/issues/232)) ([fba76e7](https://github.com/croll83/companion/commit/fba76e730ea5398a2df9dbda2167c32f49c7668f))
* **ws:** address greptile reconnect race feedback ([#549](https://github.com/croll83/companion/issues/549)) ([ea76aab](https://github.com/croll83/companion/commit/ea76aabb8a848068f6cfba3a5993a12bbf980079))
* **ws:** address greptile reconnect race feedback ([#551](https://github.com/croll83/companion/issues/551)) ([d77d0ff](https://github.com/croll83/companion/commit/d77d0ff18ea955faa7add952a27bd687cea0e0d1))
* **ws:** reconnect current session after visibility restore ([#547](https://github.com/croll83/companion/issues/547)) ([0cc1cc6](https://github.com/croll83/companion/commit/0cc1cc6bf46f5eda5ebd25d4e9511ad255024ede))


### Reverts

* **plugins:** remove event-driven plugin runtime ([#260](https://github.com/croll83/companion/issues/260)) ([ea8011a](https://github.com/croll83/companion/commit/ea8011a714b9bdac096eb7bce8a6eca9b71e0eb1))


### Code Refactoring

* **agents:** remove Vercel Chat SDK entirely, keep webhooks + Linear Agent SDK ([#493](https://github.com/croll83/companion/issues/493)) ([64a39f6](https://github.com/croll83/companion/commit/64a39f6d01746fa3894b062e5a23d154f7e668bb))
* **assistant:** remove Companion assistant feature ([#305](https://github.com/croll83/companion/issues/305)) ([7888288](https://github.com/croll83/companion/commit/7888288fb1515dd97c8db807e4d5e763ab087bd3))
* Code redundancy reduction ([#610](https://github.com/croll83/companion/issues/610)) ([c256360](https://github.com/croll83/companion/commit/c256360d6db3846e4110f1232c047ef16f939906))
* **frontend:** stabilize frontend with dead code removal, memory leak fixes, and component extraction ([#375](https://github.com/croll83/companion/issues/375)) ([b232a2e](https://github.com/croll83/companion/commit/b232a2e709ae71d0109fdcf8dfe0d7d51c202a83))
* improve type safety by fixing CLIMessage discriminated union ([#83](https://github.com/croll83/companion/issues/83)) ([2f922ef](https://github.com/croll83/companion/commit/2f922efb012b52bf6c7f49c7e6a193b3bc609e0d))
* **linear:** separate OAuth Apps from Tickets integration ([#607](https://github.com/croll83/companion/issues/607)) ([6710519](https://github.com/croll83/companion/commit/6710519081bcbde1c785c34075b9a56c5b52d898))
* rebrand the-vibe-companion to the-companion ([#162](https://github.com/croll83/companion/issues/162)) ([1bd18f1](https://github.com/croll83/companion/commit/1bd18f155aa3cd3079c0971ba980a1e6f154fb70))
* **server:** decompose ws-bridge into event pipeline ([#535](https://github.com/croll83/companion/issues/535)) ([5059845](https://github.com/croll83/companion/commit/5059845e73f9c2bff63ac9c4c8358fbccc5be06e))
* **server:** extract SessionOrchestrator for unified session lifecycle ([#533](https://github.com/croll83/companion/issues/533)) ([945b596](https://github.com/croll83/companion/commit/945b596423695c13e15d9fd0ff117a25d43a69a1))
* **server:** introduce unified IBackendAdapter for Claude & Codex ([#543](https://github.com/croll83/companion/issues/543)) ([18337b8](https://github.com/croll83/companion/commit/18337b824b8d1465eb7fca67c9002729dee764bb))
* **server:** modularize routes and ws bridge architecture ([#379](https://github.com/croll83/companion/issues/379)) ([3043e1b](https://github.com/croll83/companion/commit/3043e1bbffac5bc02c8a25dbdeba1e4f31177a65))
* **store:** migrate frontend store to domain-based slice architecture ([#534](https://github.com/croll83/companion/issues/534)) ([08739a8](https://github.com/croll83/companion/commit/08739a8df1593c553ae958727d81a7df92acd43e))
* **ui:** redesign sidebar session list for better visual hierarchy ([#539](https://github.com/croll83/companion/issues/539)) ([728702e](https://github.com/croll83/companion/commit/728702ec791aa3ff0d0b14879a3b68c8c952144d))
